    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <?php
                        ...
                        $documents = getById('documents',$paramResult);
                        if($documents){

                            if($documents['status'] == 200){
                                ?>
                                
                <input type="hidden" name="documentId" value="<?= $documents['data']['id']; ?>">

                <div class="mb-3">
                <label>Document Name</label>
                <input type="text" name="name" value="<?= $documents['data']['name']; ?>" required class="form-control"/>
                </div>
                ...
                <br/>
                <input type="checkbox" name="status" <?= $documents['data']['status'] == 1 ? 'checked':'';?> style="width:30px;height:30px;"/>
                </div>
